...
def manually_fill():
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            ENR = tk.Label(MFW, text="Enrollment ID", width=15, height=2, fg="black", bg="grey",
                           font=('times', 15))
...
message = tk.Label(window, text="Attendance Management System using Face Recognition", bg="navy blue", fg="white", width=50,
...
lbl = tk.Label(window, text="Enrollment ID: ", font=('i-imperial-celestial', 15, 'bold'))
lbl.place(x=200, y=218)
...
lbl2 = tk.Label(window, text="Student Name : ", font=('i-imperial-celestial', 15, ' bold '))
lbl2.place(x=200, y=320)
...
AP = tk.Button(window, text="Check Registered students", command=admin_panel, fg="white",
               bg="Blue", width=19, height=1, activebackground="white", font=('times', 15, ' bold '))
AP.place(x=990, y=410)

takeImg = tk.Button(window, text="Take Images", command=take_img, fg="white", bg="violet",
                    width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
takeImg.place(x=90, y=500)

trainImg = tk.Button(window, text="Train Images", fg="white", command=trainimg, bg="dark green",
                     width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
trainImg.place(x=390, y=500)

FA = tk.Button(window, text="Automatic Attendance", fg="white", command=subjectchoose,
               bg="purple", width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
FA.place(x=690, y=500)

quitWindow = tk.Button(window, text="Manual Attendance", command=manually_fill, fg="white",
                       bg="red", width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
